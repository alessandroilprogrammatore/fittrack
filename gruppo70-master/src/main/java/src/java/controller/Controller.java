...
public class Controller implements Serializable {
    ...
    /**
     * Crea e registra un nuovo hackathon.
     */
    public Hackathon creaHackathon(String titolo, String sede,
        ...
        if (!(currentUser instanceof Organizzatore)) return null;
    ...
    /**
     * Crea un nuovo team con il partecipante corrente.
     */
    ...
    /**
     * Carica un documento per l'hackathon specificato.
     */
    public Documento caricaDocumento(String filePath, Hackathon hackathon) {
        Documento d = new Documento(new File(filePath));
        d.setHackathon(hackathon);
        caricaDocumento(d);
        return d;
    }

    /**
     * Invia una votazione per un team.
     */
    public void inviaVotazione(Team team, int punteggio) {
        if (currentUser instanceof Giudice) {
            Voto v = new Voto(team, punteggio);
            voti.add(v);
        }
    }
}
