...
public class ValutaTeamGUI extends JFrame {
    ...
    private void initUI() {
        ...
        teamTable.getTableHeader().setBackground(new Color(70, 130, 180));
        teamTable.getTableHeader().setForeground(Color.WHITE);
        teamTable.setSelectionBackground(new Color(70, 130, 180));
        ...
        JButton evaluateBtn = ButtonFactory.createButton("Valuta");
        evaluateBtn.addActionListener(e -> evaluateSelectedTeam());
        buttonPanel.add(evaluateBtn);

        JButton closeBtn = ButtonFactory.createButton("Chiudi");
